...
@warning_ignore("unused_signal")
signal team_data_updated(teams: Array)
@warning_ignore("unused_signal")
signal teammate_assigned(player_id: int, teammate_id: int)
@warning_ignore("unused_signal")
signal teammate_removed(player_id: int)
@warning_ignore("unused_signal")
signal team_command_issued(team_id: int, command: Dictionary, issuer_id: int)
